...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'CompareList.repository_owner'
        db.add_column(u'comparelist_comparelist', 'repository_owner',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='repositories', null=True, to=orm['compareuser.CompareUser']),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.add_column(u'comparelist_comparelist', 'owner',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='owned_lists', null=True, to=orm['compareuser.CompareUser']),
                      keep_default=False)

        # Deleting field 'CompareList.repository_owner'
        db.delete_column(u'comparelist_comparelist', 'repository_owner_id')
