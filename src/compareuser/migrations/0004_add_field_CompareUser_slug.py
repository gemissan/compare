...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CompareUser.slug'
        db.add_column(u'compareuser_compareuser', 'slug',
                      self.gf('autoslug.fields.AutoSlugField')(default=None, unique_with=(), max_length=50, populate_from='username'),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CompareUser.slug'
        db.delete_column(u'compareuser_compareuser', 'slug')
