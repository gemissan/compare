...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'CompareUser.repository'
        db.delete_column(u'compareuser_compareuser', 'repository_id')


    def backwards(self, orm):
        # Adding field 'CompareUser.repository'
        db.add_column(u'compareuser_compareuser', 'repository',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='repository_owner', to=orm['comparelist.CompareList']),
                      keep_default=False)
