...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'comparelist_comparefeature', 'slug', self.gf('autoslug.fields.AutoSlugField')(unique_with=(), max_length=50, populate_from=None))
        # Adding field 'CompareView.name'
        db.add_column(u'comparelist_compareview', 'name',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=50),
                      keep_default=False)

        # Adding field 'CompareView.slug'
        db.add_column(u'comparelist_compareview', 'slug',
        ...
        db.create_unique(u'comparelist_compareview', ['owner_id', 'name'])


    def backwards(self, orm):
        # Removing unique constraint on 'CompareView', fields ['owner', 'name']
        db.delete_unique(u'comparelist_compareview', ['owner_id', 'name'])


        # Changing field 'CompareFeature.slug'
        db.alter_column(u'comparelist_comparefeature', 'slug', self.gf('autoslug.fields.AutoSlugField')(max_length=50, unique_with=(), populate_from='name'))
        # Deleting field 'CompareView.name'
        db.delete_column(u'comparelist_compareview', 'name')

        # Deleting field 'CompareView.slug'
        db.delete_column(u'comparelist_compareview', 'slug')
