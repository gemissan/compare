...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CompareCategory.category_type'
        db.add_column(u'compareobject_comparecategory', 'category_type',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=50, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CompareCategory.category_type'
        db.delete_column(u'compareobject_comparecategory', 'category_type')
