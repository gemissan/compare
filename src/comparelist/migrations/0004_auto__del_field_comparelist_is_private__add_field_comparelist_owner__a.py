...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'CompareList.is_private'
        db.delete_column(u'comparelist_comparelist', 'is_private')

        # Adding field 'CompareList.owner'
        db.add_column(u'comparelist_comparelist', 'owner',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='owned_lists', null=True, to=orm['compareuser.CompareUser']),
                      keep_default=False)

        # Adding field 'CompareList.private'
        db.add_column(u'comparelist_comparelist', 'private',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding unique constraint on 'CompareList', fields ['owner', 'repository_owner', 'name']
        db.create_unique(u'comparelist_comparelist', ['owner_id', 'repository_owner_id', 'name'])


    def backwards(self, orm):
        # Removing unique constraint on 'CompareList', fields ['owner', 'repository_owner', 'name']
        db.delete_unique(u'comparelist_comparelist', ['owner_id', 'repository_owner_id', 'name'])

        # Adding field 'CompareList.is_private'
        db.add_column(u'comparelist_comparelist', 'is_private',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Deleting field 'CompareList.owner'
        db.delete_column(u'comparelist_comparelist', 'owner_id')

        # Deleting field 'CompareList.private'
        db.delete_column(u'comparelist_comparelist', 'private')
    ...
    models = {
        ...
        u'comparelist.comparelist': {
            'Meta': {'unique_together': "(['owner', 'repository_owner', 'name'],)", 'object_name': 'CompareList'},
