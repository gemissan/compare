...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_index('comparelist_comparelist', ['created'])

        # Adding index on 'CompareList', fields ['owner', 'private']
        db.create_index('comparelist_comparelist', ['owner_id', 'private'])

        # Adding index on 'CompareList', fields ['owner', 'object_type']
        db.create_index('comparelist_comparelist', ['owner_id', 'object_type_id'])

        # Adding index on 'CompareList', fields ['repository_owner', 'object_type']
        db.create_index('comparelist_comparelist', ['repository_owner_id', 'object_type_id'])


    def backwards(self, orm):
        # Removing index on 'CompareList', fields ['repository_owner', 'object_type']
        db.delete_index('comparelist_comparelist', ['repository_owner_id', 'object_type_id'])

        # Removing index on 'CompareList', fields ['owner', 'object_type']
        db.delete_index('comparelist_comparelist', ['owner_id', 'object_type_id'])

        # Removing index on 'CompareList', fields ['owner', 'private']
        db.delete_index('comparelist_comparelist', ['owner_id', 'private'])

        # Removing index on 'CompareList', fields ['created']
        db.delete_index('comparelist_comparelist', ['created'])
