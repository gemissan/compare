...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('comparelist_comparefeature', 'slug',
        ...
        db.add_column('comparelist_comparelist', 'slug',
    ...
    def backwards(self, orm):
        ...
        db.delete_column('comparelist_comparefeature', 'slug')

        # Deleting field 'CompareList.slug'
        db.delete_column('comparelist_comparelist', 'slug')
