...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'CompareObjectType', fields ['ordering']
        db.create_index(u'compareobject_compareobjecttype', ['ordering'])


    def backwards(self, orm):
        # Removing index on 'CompareObjectType', fields ['ordering']
        db.delete_index(u'compareobject_compareobjecttype', ['ordering'])
