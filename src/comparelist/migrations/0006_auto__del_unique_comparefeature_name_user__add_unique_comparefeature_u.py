...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_unique('comparelist_comparefeature', ['user_id', 'name'])


        # Changing field 'CompareList.object_type'
        db.alter_column('comparelist_comparelist', 'object_type_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['compareobject.CompareObjectType']))
        # Deleting field 'CompareView.is_private'
        db.delete_column('comparelist_compareview', 'is_private')

        # Adding field 'CompareView.private'
        db.add_column('comparelist_compareview', 'private',
    ...
    def backwards(self, orm):
        ...
        db.delete_unique('comparelist_comparefeature', ['user_id', 'name'])
        ...
        # Changing field 'CompareList.object_type'
        db.alter_column('comparelist_comparelist', 'object_type_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['compareobject.CompareObjectType']))
        # Adding field 'CompareView.is_private'
        db.add_column('comparelist_compareview', 'is_private',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Deleting field 'CompareView.private'
        db.delete_column('comparelist_compareview', 'private')
