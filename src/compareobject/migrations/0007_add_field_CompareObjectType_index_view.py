...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CompareObjectType.index_view'
        db.add_column(u'compareobject_compareobjecttype', 'index_view',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=50, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CompareObjectType.index_view'
        db.delete_column(u'compareobject_compareobjecttype', 'index_view')
