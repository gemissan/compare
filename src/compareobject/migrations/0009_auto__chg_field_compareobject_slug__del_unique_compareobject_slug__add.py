...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_unique(u'compareobject_compareobject', ['slug'])


        # Changing field 'CompareObject.slug'
        db.alter_column(u'compareobject_compareobject', 'slug', self.gf('autoslug.fields.AutoSlugField')(unique_with=(), max_length=50, populate_from='name'))
        # Adding field 'CompareCategory.slug'
        db.add_column(u'compareobject_comparecategory', 'slug',
        ...
        db.add_column(u'compareobject_compareobjecttype', 'slug',
                      self.gf('autoslug.fields.AutoSlugField')(default=None, unique_with=(), max_length=50, populate_from='name'),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Changing field 'CompareObject.slug'
        db.alter_column(u'compareobject_compareobject', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=255, unique=True))
        # Adding unique constraint on 'CompareObject', fields ['slug']
        db.create_unique(u'compareobject_compareobject', ['slug'])

        # Deleting field 'CompareCategory.slug'
        db.delete_column(u'compareobject_comparecategory', 'slug')

        # Deleting field 'CompareObjectType.slug'
        db.delete_column(u'compareobject_compareobjecttype', 'slug')
    ...
    models = {
        ...
        u'compareobject.comparision': {
            ...
            'compare_feature': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': u"orm['comparelist.CompareFeature']", 'null': 'True', 'blank': 'True'}),
