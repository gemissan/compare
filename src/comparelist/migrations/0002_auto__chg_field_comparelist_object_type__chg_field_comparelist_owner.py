...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'CompareList.owner'
        db.alter_column(u'comparelist_comparelist', 'owner_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['compareuser.CompareUser']))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'CompareList.owner'
        db.alter_column(u'comparelist_comparelist', 'owner_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['compareuser.CompareUser']))
